...
class TaskDeadline {
  ...
  /// 他の期限より後かどうかを判定
  bool isAfter(TaskDeadline other) => value.isAfter(other.value);

  /// 他の期限より前かどうかを判定
  bool isBefore(TaskDeadline other) => value.isBefore(other.value);

  /// 他の期限と同じかどうかを判定
  bool isSame(TaskDeadline other) => value.isAtSameMomentAs(other.value);

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TaskDeadline &&
  ...
  @override
  String toString() =>
      'TaskDeadline(${value.year}-${value.month}-${value.day})';
}
